...
| `PUBLIC_TRACKING_PIN_SESSION_MINUTES` | Server                | No       | Duration of the signed recipient-PIN browser session. Defaults to `60` minutes.     |
...
| `SMTP_MONITORING_INTERVAL_SECONDS`    | Server                | No       | Cached interval for the SMTP TLS/authentication health probe. Defaults to `300`.    |
